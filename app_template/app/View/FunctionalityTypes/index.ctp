...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="functionalityTypes index">
			...
			<h2><?php echo __('Functionality Types'); ?></h2>
...
<?php foreach ($functionalityTypes as $functionalityType): ?>
	<tr>
		<td><?php echo h($functionalityType['FunctionalityType']['id']); ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $functionalityType['FunctionalityType']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $functionalityType['FunctionalityType']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $functionalityType['FunctionalityType']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $functionalityType['FunctionalityType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
