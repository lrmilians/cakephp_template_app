...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FunctionalityType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FunctionalityType.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<h2><?php echo __('Edit Functionality Type'); ?></h2>
